...
$today = date('Ymd-His');
$history_link = '../conjugaison_verbe/resultats/' . $_SESSION['prenom'] . '-conjugaison_verbe-' . $today . '.txt';
...
$stmt->execute([$_SESSION['user_id'], 'conjugaison_verbe', $_SESSION['nbBonneReponse'], $_SESSION['nbQuestion'], $history_link]);
?>

...
$today = date('Ymd-His');
$history_link = '../multiplication/resultats/' . $_SESSION['prenom'] . '-multiplication-' . $today . '.txt';
...
$stmt->execute([$_SESSION['user_id'], 'multiplication', $_SESSION['nbBonneReponse'], $_SESSION['nbQuestion'], $history_link]);
?>

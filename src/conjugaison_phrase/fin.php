...
$today = date('Ymd-His');
$history_link = '../conjugaison_phrase/resultats/' . $_SESSION['prenom'] . '-conjugaison_phrase-' . $today . '.txt';
...
$stmt->execute([$_SESSION['user_id'], 'conjugaison_phrase', $_SESSION['nbBonneReponse'], $_SESSION['nbQuestion'], $history_link]);
?>

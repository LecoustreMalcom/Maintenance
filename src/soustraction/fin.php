...
$today = date('Ymd-His');
$history_link = '../soustraction/resultats/' . $_SESSION['prenom'] . '-soustraction-' . $today . '.txt';
...
$stmt->execute([$_SESSION['user_id'], 'soustraction', $_SESSION['nbBonneReponse'], $_SESSION['nbQuestion'], $history_link]);
?>
